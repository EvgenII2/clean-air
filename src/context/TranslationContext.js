...
export const translations = {
    ...
    ru: {
        ...
        sectionDescText: [
            'Достаточно просто включить и занимайтесь своими делами, не выходя из помещения: воздух благодаря работе вентиляторов поступает в рециркулятор и происходит его очистка от пыли, бактерий и микробов.',
